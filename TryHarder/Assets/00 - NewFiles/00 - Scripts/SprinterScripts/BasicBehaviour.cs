...
public class BasicBehaviour : MonoBehaviour
{
	...
	// Basic definitions
	//-----------------------------------
	public float GetH { get { return h; } }										// Get current horizontal axes.
	public float GetV { get { return v; } }										// Get current vertical axes.
	public ThirdPersonOrbitCamBasic GetCamScript { get { return camScript; } }	// Get the player camera script.
	public Rigidbody GetRigidBody { get { return rBody; } }						// Get the player's rigid body.
	public Animator GetAnim { get { return anim; } }						    // Get the player's animator controller.
	public int GetDefaultBehaviour {  get { return defaultBehaviour; } }		// Get current default behaviour.
	...
	// Attempt to set a custom behaviour as the active one. (Always changes from default behaviour to the passed one.)
...
public abstract class GenericBehaviour : MonoBehaviour
{
	...
	public int GetBehaviourCode(){return behaviourCode;}

	// Check if the behaviour allows sprinting.
	public bool AllowSprint(){return canSprint;}
}
